...
public class RegisterFx {
    ...
    public PasswordField validationCode;
    ...
    private void registerHandlers() {
        ...
        submit.setOnAction(event -> {
            ...
            if(validationCode.getText().isEmpty()){
                validationCode.setStyle("-fx-text-box-border: #AA0000");
                return;
            }
            ...
            try {
                ...
                dateField.setStyle("");
                model.rRegister(new Register(nameField.getText(), emailField.getText(), passField.getText(), date, validationCode.getText()));

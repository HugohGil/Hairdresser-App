...
public class Schedule {
    ...
    private void registerHandlers() {
        ...
        schedule.setOnMouseClicked(mouseEvent -> {
            ...
            model.rAddService(new Service(request.getId(), hairDresser.getSelectionModel().getSelectedItem().getId()
                    , dateStart, dateEnd, List.of(typeOfService.getSelectionModel().getSelectedItem())));
